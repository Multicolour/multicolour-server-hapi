...
class Verb {
  ...
  get_error_schemas(validators) {
    ...
    validators.forEach(validator => valids.push(validator.error_schema))
  ...
  get_response_schemas(validators) {
    ...
    validators.forEach(validator => {
      const schema = Joi.object(validator.schemas.get[this._name])
  ...
  get_payload_schemas(validators) {
    ...
    // Add each valid payload.
    validators.forEach(validator => valids.push(validator.schemas[this._verb.toLowerCase()][this._name]))
      ...
      config: {
        ...
        response: {
          schema: this.get_response_schemas(validators)
            ...
            .label(`${this._class_name}_response`)
        }
      }
    }

...
class Verb {
  ...
  get_response_schemas(validators) {
    ...
    validators.forEach(validator => {
      valids.push(validator.schemas[this._name])
      valids.push(Joi.array(validator.schemas[this._name]))
    })
  ...
  get_payload_schemas(validators) {
    ...
    // Add each valid payload.
    validators.forEach(validator => valids.push(validator.schemas[this._name]))
